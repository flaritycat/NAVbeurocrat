...
const processSteps = [
  {
    ...
    description: "Du starter med hva som passer best for deg akkurat nå, ikke med et navn på en ytelse.",
  },
  {
  ...
  {
    title: "3. Akutte forhold løftes opp",
    description: "Hvis mat, bolig eller andre grunnleggende behov haster, vises det først i resultatet.",
  },
  {
    title: "4. Få en ryddig oppsummering",
    description: "Du får anbefalt hovedløp, alternative muligheter, dokumentasjonsliste og forslag til formulering.",
  },
  {
    title: "5. Bruk offisielle kilder videre",
    description: "Resultatet peker videre til NAV, Husbanken og andre offisielle kilder der det passer.",
  },
  {
    ...
    <div className="page">
      <section className="hero-card">
        <div>
          ...
          <h1>Finn hvilke NAV-ordninger og hjelpetiltak som kan være relevante.</h1>
          <p className="lead">
            Denne veiviseren er laget for privatpersoner i Norge som trenger en rolig og tydelig oversikt over hva som
            kan være riktig å undersøke videre hos NAV eller kommunen.
          </p>
        ...
        <div className="hero-card__signals">
          <div className="signal-card">
            ...
            <p>Du trenger ikke konto eller autentisering for å bruke veiviseren.</p>
          </div>
          <div className="signal-card">
          ...
          <section className="card">
            ...
            <div className="stack">
              <article className="note-box note-box--fact">
                <h3>Anbefalt hovedløp</h3>
                <p>Den ordningen eller tjenesten som ser mest relevant ut basert på svarene dine.</p>
              </article>
              <article className="note-box note-box--warning">
                <h3>Hva som haster</h3>
                <p>Akutte forhold løftes foran mer langsiktige løp når det er nødvendig.</p>
              </article>
              <article className="note-box note-box--missing">
                <h3>Dokumentasjon og formulering</h3>
                <p>Du får en kort liste over hva du bør samle, og forslag til hvordan du kan formulere deg saklig.</p>
              </article>
            </div>
          </section>
